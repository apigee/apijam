...
3. Click on **Send** button multiple times, You will see 429 or 500 response codes when spike arrest policy kicks in to protect target servers from spike in traffic.
